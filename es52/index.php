...
Our project has two major components--the transmitting stage and the receiving stage. Both pieces are centered on a Arduino Due microcontroller (of which we used 2), which is used to digitize and store the message and control the user experience. Additionally both stages use analog filtering, amplification, etc., to maintain the highest possible audio quality though the record-->store-->transmit-->record-->store-->playback sequence.</br></br>
...
<div class="modal fade" id = "introModal">
  ...
  ga('create', 'UA-46410526-1', 'jaredarosen.com');
  ga('send', 'pageview');
